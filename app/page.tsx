  ...
  return (
    <div className="relative min-h-screen flex flex-col bg-background text-foreground font-sans">
      ...
      <header className="relative z-10 w-full border-b border-border bg-card h-16 flex items-center shadow-xs">
        <nav
          className="w-full max-w-7xl mx-auto flex justify-between items-center px-6"
          aria-label="Menu principal"
        >
          <div className="flex items-center gap-3">
            <div
              className="p-1.5 border-2 border-primary bg-primary/10 text-primary"
              aria-hidden="true"
            >
              <ScanLine size={18} />
            </div>
          ...
          <div className="flex items-center gap-4">
            <Button
              ...
              variant="outline"
              size="sm"
              className="h-9 px-6 border-border font-black text-[10px] uppercase tracking-widest rounded-none hover:bg-muted focus-visible:ring-2 focus-visible:ring-primary"
            >
              <Link href="/staff/login">Espace Personnel</Link>
            </Button>
          </div>
        </nav>
      </header>
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center text-center px-6 py-12 md:py-24 max-w-7xl mx-auto w-full">
        <div className="space-y-8 max-w-4xl">
          <p className="inline-flex items-center gap-2 px-4 py-1.5 border border-primary/20 bg-primary/5 text-primary text-[10px] font-black uppercase tracking-[0.2em]">
          ...
          <p className="text-base md:text-xl text-muted-foreground max-w-2xl mx-auto font-medium leading-relaxed">
            Synchronisez les prescriptions médicales et la production culinaire
            pour garantir sécurité et satisfaction à chaque repas.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-10">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto h-14 px-10 border-2 border-primary bg-primary text-primary-foreground font-black uppercase tracking-[0.2em] text-xs shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)] hover:translate-y-[-2px] hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,0.1)] active:translate-y-[0px] transition-all rounded-none focus-visible:ring-4 focus-visible:ring-primary/30"
            >
              <Link href="/patient" className="w-full sm:w-auto flex items-center gap-3">
                <span>Accès Portail Patient</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 mt-24 border-2 border-border bg-border shadow-xl">
          <section className="p-10 bg-card flex flex-col items-center text-center space-y-4 hover:bg-muted/30 transition-colors border-r border-border md:border-r last:border-r-0">
            <div
              className="w-14 h-14 border border-blue-500/20 bg-blue-500/10 text-blue-600 flex items-center justify-center mb-2"
              aria-hidden="true"
            >
              <Stethoscope size={28} />
            </div>
            ...
            <p className="text-xs font-bold leading-loose text-muted-foreground uppercase opacity-80">
              Gestion des pathologies et allergies critiques en temps réel.
            </p>
          </section>

          <section className="p-10 bg-card flex flex-col items-center text-center space-y-4 hover:bg-muted/30 transition-colors border-r border-border md:border-r last:border-r-0">
            <div
              className="w-14 h-14 border border-orange-500/20 bg-orange-500/10 text-orange-600 flex items-center justify-center mb-2"
              aria-hidden="true"
            >
            ...
            <p className="text-xs font-bold leading-loose text-muted-foreground uppercase opacity-80">
              Optimisation de la production et traçabilité des ingrédients.
            </p>
          </section>

          <section className="p-10 bg-card flex flex-col items-center text-center space-y-4 hover:bg-muted/30 transition-colors">
            <div
              className="w-14 h-14 border border-primary/20 bg-primary/10 text-primary flex items-center justify-center mb-2"
              aria-hidden="true"
            >
              <ScanLine size={28} />
            </div>
            ...
            <p className="text-xs font-bold leading-loose text-muted-foreground uppercase opacity-80">
              Personnalisation des menus via QR code ou identifiant unique.
            </p>
          </section>
        </div>
      </main>
